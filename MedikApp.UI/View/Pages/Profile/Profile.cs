...
namespace MedikApp.UI
{
    ...
    public partial class Profile : UserControl
    {
        ...
        private ResetPassword sg;

        public Profile(ResetPassword sg)
        {
            this.sg = sg;
            InitializeComponent();
        ...
        private async void Profil_Load(object sender, EventArgs e)
        {
            ...
            string tcNo = LogIn.UserInfo.tc; // Kullanıcının TC numarasını al
            person = await GetApiDataAsync(tcNo);
            int yas = Helper.YasHesapla(person.DogumTarihi);
            ...
            kan = Helper.GetKanGurubuById(Int32.Parse(person.KanGurubu));
            comboBox1.Text = kan;
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i <= 8; i++)
            {
                comboBox1.Items.Add(Helper.GetKanGurubuById(i));
            }
        ...
        private async void button3_Click(object sender, EventArgs e)
        {
            ...
            int kanId = Helper.GetKanGurubuId(comboBox1.Text);
